...
public class ClientSwingView extends SwingView implements ClientTCRMView {
	...
	protected JPanel centerGrid;//Added this so that we could add things to it and not start at zero.
	...
	public ClientSwingView() {
		...
		JScrollPane centerScrollPane = new JScrollPane();//Changed this accordingly with the variable
